"""
Run one pending validation case through the frozen v0.15 pipeline using direct
...
Example:
    uv run python evals/run_judge_validation_direct_transport.py `
      --resume evals/runs/semantic_relevance_validation/<RUN_ID> `
      --case-id U_Q09_T02
"""
...
class DirectOllamaTransport:
    ...
    def generate(
        ...
        **_: Any,
        ...
        if schema is None:
            raise TypeError("Frozen v0.15 validation expects structured-output schemas.")
