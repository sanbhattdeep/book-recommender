"""Check the preregistered v0.21.2 targeted regression on a partial run."""
...
MANIFEST = REPO_ROOT / "evals" / "datasets" / "semantic_relevance_v0.21_regression_manifest.v1.1.0.json"
DATASET = REPO_ROOT / "evals" / "datasets" / "semantic_relevance_v0.21_development.v2.0.0.csv"
...
def main() -> None:
    ...
    print("v0.21.2 targeted regression")
    print("-------------------------")
    all_pass=True
