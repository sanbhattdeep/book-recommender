"""Deterministic polarity-aware DIRECT cue tests for v0.22.0. No LLM is called."""
...
CONFIG_FILE = EVALS_DIR / "judge_configs" / "semantic_relevance_judge.v0.22.1.json"
...
print("All v0.22.0 polarity-aware deterministic-cue tests passed.")
