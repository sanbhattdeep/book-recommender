...
This is a drop-in replacement for evals/analyze_v0_26_development.py when
Windows Application Control blocks SciPy native DLLs.

Usage:
    uv run python evals/analyze_v0_26_development.py `
      --run evals/runs/semantic_relevance_v0_26_development/<RUN_ID>
"""
...
REGRESSION_MANIFEST = (
    ...
    / "evals"
    / "datasets"
    / "semantic_relevance_v0.26_regression_manifest.v6.2.0.json"
)
