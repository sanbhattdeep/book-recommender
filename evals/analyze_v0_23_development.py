"""
Analyze the 90-case v0.23 consumed-development run without scikit-learn/scipy.

This is a drop-in replacement for evals/analyze_v0_23_development.py when
Windows Application Control blocks SciPy native DLLs.

Usage:
    uv run python evals/analyze_v0_23_development.py `
      --run evals/runs/semantic_relevance_v0_23_development/<RUN_ID>
"""
...
EXPECTED_JUDGE_CONFIG_VERSION = "0.23.0"
...
REGRESSION_MANIFEST = (
    ...
    / "evals"
    / "datasets"
    / "semantic_relevance_v0.23_regression_manifest.v2.0.0.json"
)
...
def main() -> None:
    ...
    print()
    print("Targeted v0.23 regression checks")
    print("----------------------------------")
