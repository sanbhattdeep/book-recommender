...
required = [
    ...
    E / "judge_configs/semantic_relevance_judge.v0.24.0.json",
    ...
    E / "datasets/semantic_relevance_v0.24_regression_manifest.v3.0.0.json",
    E / "datasets/semantic_relevance_label_revisions.v1.0.0.json",
    E / "analyze_v0_24_targeted.py",
    E / "analyze_v0_24_development.py",
    E / "run_judge_development.py",
    E / "run_judge_development_direct_transport.py",
    E / "build_v0_24_development_dataset.py",
]
for path in required:
    assert path.exists(), path

cfg = json.loads(required[2].read_text(encoding="utf-8"))
assert cfg["version"] == "0.24.0"
...
assert "component_evidence_ledger_verification" in cfg["pipeline"]
...
for required_text in [
    ...
    "component resurrection is forbidden",
...
# Frozen scoring/facet/rubric artifacts remain byte-identical to v0.22.2/v0.23.
expected_hashes = {
...
for name in [
    ...
    "test_v0_24_verifier_recovery.py",
    "test_v0_24_no_hard_exclusion_normalization.py",
...
print("v0.24.0 package verification passed.")
