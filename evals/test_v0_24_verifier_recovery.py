"""v0.24.0 retries a structurally inconsistent positive verifier output conservatively."""
from __future__ import annotations

import json
from pathlib import Path

from semantic_relevance_facet_judge import ComponentEvidenceCheck, EvidenceVerification, verify_candidate_evidence
    ...
    def generate(self, prompt, schema, **kwargs):
        ...
        if self.calls == 1:
            ...
            return EvidenceVerification(
                ...
                component_checks=[
                    ComponentEvidenceCheck(component_id="danger", established=True, supporting_span_ids=["S1"], reason="danger grounded"),
                    ComponentEvidenceCheck(component_id="travel or movement", established=False, supporting_span_ids=[], reason="movement missing"),
                ],
...
print("v0.24.0 verifier component-repair retry passed")
