"""
Run one pending development case through the v0.27 development pipeline using direct
...
class DirectOllamaTransport:
    ...
    def generate(
        ...
        **_: Any,
        ...
        if schema is None:
            raise TypeError("v0.27 development expects structured-output schemas.")
