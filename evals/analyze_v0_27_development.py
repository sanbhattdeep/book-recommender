...
Usage:
    uv run python evals/analyze_v0_27_development.py `
      --run evals/runs/semantic_relevance_v0_27_development/<RUN_ID>
"""
...
def main() -> None:
    ...
    if mismatches:
        raise ValueError(
            "Run is not the expected v0.27 development run:\n- "
            + "\n- ".join(mismatches)
        )
    ...
    print()
    print("Targeted v0.27 regression checks")
    print("----------------------------------")
