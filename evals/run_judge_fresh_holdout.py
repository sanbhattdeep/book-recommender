"""Run frozen Semantic Recommendation Relevance Judge v0.18.0 on the final holdout split.
...
EVALUATION_DATASET_ROLE = "fresh_unseen_final_holdout"
EVALUATION_SCOPE = "fresh_unseen_final_holdout"
...
#
#     <repo>/evals/run_judge_fresh_holdout.py
#
...
DATASET_FILE = (EVALS_DIR / "datasets" / "semantic_relevance_fresh_holdout.v2.0.0.DO_NOT_RUN_YET.csv")
...
RUNS_DIR = (EVALS_DIR / "runs" / "semantic_relevance_v0_18_fresh_holdout")
...
# =============================================================================
# Main fresh unseen final holdout loop
# =============================================================================

def main() -> None:

    parser = argparse.ArgumentParser(
        description="Run frozen v0.18 judge on the 30-case final holdout split."
    )
