"""
Analyze the 90-case v0.24 consumed-development run without scikit-learn/scipy.

This is a drop-in replacement for evals/analyze_v0_24_development.py when
Windows Application Control blocks SciPy native DLLs.

Usage:
    uv run python evals/analyze_v0_24_development.py `
      --run evals/runs/semantic_relevance_v0_24_development/<RUN_ID>
"""
...
EXPECTED_JUDGE_CONFIG_VERSION = "0.24.0"
...
REGRESSION_MANIFEST = (
    ...
    / "evals"
    / "datasets"
    / "semantic_relevance_v0.24_regression_manifest.v3.0.0.json"
)
...
def main() -> None:
    ...
    print()
    print("Targeted v0.24 regression checks")
    print("----------------------------------")
