...
CONFIG=json.loads((ROOT/'evals/judge_configs/semantic_relevance_judge.v0.21.0.json').read_text(encoding="utf-8"))
...
for bad in [
    ...
    try:
        ...
        pass
print('v0.21 verifier hard-exclusion contract tests passed.')
