...
cfg = json.loads((ROOT / 'evals/judge_configs/semantic_relevance_judge.v0.25.0.json').read_text())
facet = json.loads((ROOT / 'evals/facets/semantic_relevance/semantic_relevance_query_facets.v0.9.0.json').read_text())
...
assert facet['version'] == '0.9.0' and facet['status'] == 'frozen'
...
print('v0.25.0 frozen facet/rubric contract passed')
