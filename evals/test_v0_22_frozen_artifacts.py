...
facet = json.loads((ROOT / 'evals/facets/semantic_relevance/semantic_relevance_query_facets.v0.9.1.json').read_text())
...
assert facet['version'] == '0.9.1' and facet['status'] == 'frozen'
