...
cfg = json.loads((ROOT / 'evals/judge_configs/semantic_relevance_judge.v0.26.0.json').read_text(encoding="utf-8"))
facet = json.loads((ROOT / 'evals/facets/semantic_relevance/semantic_relevance_query_facets.v0.9.3.json').read_text(encoding="utf-8"))
...
assert facet['version'] == '0.9.3' and facet['status'] == 'frozen'
