...
required=[
 ...
 E/'judge_configs/semantic_relevance_judge.v0.22.1.json',
 ...
 E/'datasets/semantic_relevance_v0.22_regression_manifest.v1.1.0.json',
...
print('v0.22.1 package verification passed.')
