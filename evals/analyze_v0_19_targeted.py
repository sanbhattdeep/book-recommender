"""Check the preregistered v0.19 targeted regression on a partial run."""
...
MANIFEST = REPO_ROOT / "evals" / "datasets" / "semantic_relevance_v0.19_regression_manifest.v1.0.0.json"
DATASET = REPO_ROOT / "evals" / "datasets" / "semantic_relevance_v0.19_development.v2.0.0.csv"
...
def main() -> None:
    ...
    print("v0.19 targeted regression")
    print("-------------------------")
    all_pass=True
