"""Verify required v0.20 artifacts are execution-ready."""
from pathlib import Path
import json
ROOT=Path(__file__).resolve().parents[1]
FACET=ROOT/"evals/facets/semantic_relevance/semantic_relevance_query_facets.v0.8.0.json"
CONFIG=ROOT/"evals/judge_configs/semantic_relevance_judge.v0.20.0.json"
...
assert config.get("version")=="0.20.0"
assert rubric.get("version")=="0.1.0"
assert set(rubric.get("scores",{}))=={"0","1","2","3","4"}
print("v0.20 frozen-artifact contract passed.")
