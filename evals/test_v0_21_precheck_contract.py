...
config=json.loads((ROOT/'evals/judge_configs/semantic_relevance_judge.v0.21.2.json').read_text(encoding="utf-8"))
specs=json.loads((ROOT/'evals/facets/semantic_relevance/semantic_relevance_query_facets.v0.8.0.json').read_text(encoding="utf-8"))
...
print('v0.21.2 hard-exclusion precheck contract passed')
